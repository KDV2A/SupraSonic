...
#if canImport(suprasonic_coreFFI)
import suprasonic_coreFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_suprasonic_core_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_suprasonic_core_rustbuffer_free(self, $0) }
    }
}
...
open class AppState:
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_suprasonic_core_fn_clone_appstate(self.pointer, $0) }
    }
public convenience init() {
    let pointer =
        try! rustCall() {
    uniffi_suprasonic_core_fn_constructor_appstate_new($0
    )
}
    ...
    deinit {
        ...
        try! rustCall { uniffi_suprasonic_core_fn_free_appstate(pointer, $0) }
    }
...
open func stopRecording()throws  {try rustCallWithError(FfiConverterTypeSupraSonicError.lift) {
    uniffi_suprasonic_core_fn_method_appstate_stop_recording(self.uniffiClonePointer(),$0
    )
}
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeSupraSonicError: FfiConverterRustBuffer {
    typealias SwiftType = SupraSonicError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SupraSonicError {
    ...
    public static func write(_ value: SupraSonicError, into buf: inout [UInt8]) {
        switch value {
...
extension SupraSonicError: Equatable, Hashable {}

extension SupraSonicError: Foundation.LocalizedError {
    public var errorDescription: String? {
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_suprasonic_core_checksum_method_appstate_stop_recording() != 50041) {
        return InitializationResult.apiChecksumMismatch
    }
